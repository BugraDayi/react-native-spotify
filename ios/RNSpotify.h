...
//setMediaPlayerInfo(name, artist, duration)
-(void)setMediaPlayerInfo:(NSString*)name artist:(NSString*)artist duration:(NSNumber*)duration resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject;
